// import characters from './assets/fma-data.ts'
import './Css/App.css'
import './Css/chara-cards.css'
import './Css/chara-ratings.css'

// const selectedFields = ['name', 'skillset', 'votes'];
// const namePull = ['name', 'nickName']
     ...
     <section id="character-ratings">
       ...
       <table>
         ...
         {/* {characters.map((character, index) => (
          <tr key={character.id} className ={`${index % 2 === 0 ? 'light' : 'dark'}`}>
            {selectedFields.map((field) => (
              <td key={field + character.id}>{character[field]}</td>
            ))}
          </tr>
        ))} */}
